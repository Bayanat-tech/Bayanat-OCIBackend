...
export class BTFilesVHService {
  private static instance: BTFilesVHService;
  private repository: Repository<FilesVHEntity> | null = null;

  private constructor() {}

  static async getInstance(): Promise<BTFilesVHService> {
    if (!BTFilesVHService.instance) {
      BTFilesVHService.instance = new BTFilesVHService();
    }

    await BTFilesVHService.instance.ensureRepository();
    return BTFilesVHService.instance;
  }
