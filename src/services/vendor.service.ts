...
// import { TypeORMService } from "sequelize";
...
//   getdynamicdata: async (vs_parameter: string, vs_where: string) => {
//     try {
...
//   getPendingLPOList: async (company_code: string, ac_code: string) => {
//     const response = await axiosInstance.get(
...
//   insertAcHeader: async (headerData: Record<string, any>) => {
...
//   insertAcDetail: async (detailData: Record<string, any>) => {
...
//   insertUploadedFile: async (fileData: Record<string, any>) => {
//     try {
//       // Log the payload being sent
...
//   insertVendor: async (vendorData: Record<string, any>) => {
...
//   updateDataTransferFlag: async (companyCode: string, docNo: string) => {
//     const query = `
//       UPDATE TR_AC_LPO_HEADER
//       SET DATA_TRANSFER = 'Y'
//       WHERE COMPANY_CODE = ? AND DOC_NO = ?
//     `;
//     await sequelize.query(query, {
//       replacements: [companyCode, docNo],
//       type: QueryTypes.UPDATE,
//     });
//   },

//   checkAccountEmployee: async (userId: string) => {
//     try {
//       const response = await axiosInstance.get(
...
//   getPartyAccountStatement: async (
//     companyCode: string,
//     acCode: string,
//     docDateFrom: string,
//     docDateTo: string
...
//   getPartyOutstanding: async (companyCode: string, acCode: string) => {
//     try {
//       const response = await axiosInstance.get(
...
//   getTmpAcHeaderWithErpDocNo: async (loginid: string) => {
//     try {
//       const response = await axiosInstance.get(
...
//   cleanDetail: (detail: Record<string, any>): Record<string, any> => {
//     const cleanedDetail = { ...detail };
