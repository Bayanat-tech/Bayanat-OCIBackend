...
console.log("==================================🤩🤩");
        ...
        prodMap.forEach((prod) => {
            ...
            // ── Transaction rows ──────────────────────────────────────
            prod.rows.forEach((r) => {
                const qty    = num(r.qunatity); // note DB alias spelling
        ...
        // ── Split into pages ──────────────────────────────────────────────
        // Each "row" in allTrRows is actually 1 <tr> string (but a product header
        // is already 2 tr's merged as 1 push). We paginate by item count.
