...
export const insUpdTtePInvoiceBulk = async (
  req: Request,
  res: Response
): Promise<void> => {


  console.log("insUpdTtePInvoiceBulk called-------------");
