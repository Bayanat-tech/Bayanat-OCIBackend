  ...
  try {
    ...
    const result = await connection.execute(
      ...
      `,
      {
        ...
        val1s8: body.val1s8,
        val1s9: body.val1s9,
        val1s10: body.val1s10,
        val1s11: body.val1s11,
        val1s12: body.val1s12,
        val1s13: body.val1s13,
        val1s14: body.val1s14,
        val1s15: body.val1s15,
        val1s16: body.val1s16,
        val1s17: body.val1s17,
        val1s18: body.val1s18,
        val1s19: body.val1s19,
        val1s20: body.val1s20,
