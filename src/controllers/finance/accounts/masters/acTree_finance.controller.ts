export const getAcTree = async (req: any, res: any) => { throw new Error('Not implemented'); };
export const getLevel3AcTreeNode = async (req: any, res: any) => { throw new Error('Not implemented'); };
export const createLevel3AcTreeNode = async (req: any, res: any) => { throw new Error('Not implemented'); };
export const updateLevel3AcTreeNode = async (req: any, res: any) => { throw new Error('Not implemented'); };
export const getLevel4AcTreeNode = async (req: any, res: any) => { throw new Error('Not implemented'); };
export const createLevel4AcTreeNode = async (req: any, res: any) => { throw new Error('Not implemented'); };
export const updateLevel4AcTreeNode = async (req: any, res: any) => { throw new Error('Not implemented'); };
export const getAccountChildrenAcTreeNode = async (req: any, res: any) => { throw new Error('Not implemented'); };
export const createAccountChildrenAcTreeNode = async (req: any, res: any) => { throw new Error('Not implemented'); };
export const updateAccountChildrenAcTreeNode = async (req: any, res: any) => { throw new Error('Not implemented'); };
export const deleteAccountItem = async (req: any, res: any) => { throw new Error('Not implemented'); };
