...
export const getLedgerWithOppositeEntryReport = async (req: Request, res: Response): Promise<void> => {
    ...
    try {
      ...
      <title>Ledger With Opposite Entry Report</title>
      <style>
        ...
        .sub-row td { font-size: 9px; color: #555; border-bottom: 1px solid #f0f0f0; }
      ...
      <div class="page">
        <div class="header-top">
          <table class="meta-info">
            ...
            <tr><td class="label">Report :</td><td>rpt_ac_ledger_grp1</td></tr>
          </table>
        ...
        <table class="report-table">
          <thead>
            ...
            <tr>
              <th colspan="4">Salesman Code/Name</th>
              <th colspan="6">Ref Ac Code/ Name</th>
            </tr>
          </thead>
