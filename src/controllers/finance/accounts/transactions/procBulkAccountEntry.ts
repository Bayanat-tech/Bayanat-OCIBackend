      ...
      `,
      {
        ...
        p_detail: {
          ...
          val: details.map((d: any) => ({
            ...
            REMARKS: d.remarks,
            AMOUNT: d.amount,
            SIGN_IND: normalizeSignInd(d.sign_code ?? d.sign_ind, defaultDetailSign(d.doc_type || header.doc_type)),
        ...
        p_invdetail: {
          ...
          val: invoiceDetail.map((d: any) => ({
            ...
            AMOUNT: d.amount,
            LCUR_AMOUNT: d.lcur_amount,
            SIGN_IND: defaultInvoiceSign(d.doc_type || header.doc_type) ?? normalizeSignInd(d.sign_code ?? d.sign_ind, defaultDetailSign(d.doc_type || header.doc_type)),
            CURR_CODE: d.curr_code,
            EX_RATE: d.ex_rate,
